...
class LibraryFunctionsTest {
    ...
    void setUp() {
        // Supplying test data
        library = new Library();
        library.addBook(new Book("TestTitle1", "TestAuthor1", "111","TestGenre1", "checked in", null));
        library.addBook(new Book("TestTitle2", "TestAuthor2", "222", "TestGenre2", "checked in", null));
    }
    ...
    void addBook_Test() {
        ...
        Book newBook = new Book("TestTitle3", "TestAuthor3", "333", "TestGenre3", "checked in", null);
